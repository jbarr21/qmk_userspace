...
#define _DEF \
    ...
    OSL(FUN), KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,        KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, OSL(IDE), \
             LT(MOU,KC_TAB), LT(NAV,KC_BSPC), OSM_SFT,        KC_ENT, LT(SYM,KC_SPC), OSL(IDE)
...
#define _NAV \
    ...
    KC_TAB,  OSM_CTL, OSM_ALT, OSM_SFT, OSM_GUI, KC_VOLD,     XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, \
    XXXXXXX, UNDO,    CUT,     COPY,    PASTE,   KC_MUTE,     XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  LLOCK,   \
                               XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, APP_WIN, XXXXXXX

#define _NUM \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_7,    KC_8,    KC_9,    XXXXXXX, XXXXXXX, \
    XXXXXXX, OSM_CTL, OSM_ALT, OSM_SFT, OSM_GUI, XXXXXXX,     XXXXXXX, KC_4,    KC_5,    KC_6,    KC_0,    KC_DOT,  \
...
#define _MOU \
    ...
    XXXXXXX, OSM_CTL, OSM_ALT, OSM_SFT, OSM_GUI, XXXXXXX,     XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX, \
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, LLOCK,   \
                               XXXXXXX, XXXXXXX, XXXXXXX,     KC_F16,  KC_BTN1, KC_BTN2
