...
#define _NUM \
    ...
    OSL(FUN), OSM_CTL, OSM_ALT, OSM_SFT, OSM_GUI, XXXXXXX,    XXXXXXX, KC_4,    KC_5,    KC_6,    KC_0,    KC_DOT,  \
...
#define _MOU \
    ...
    TO(DEF), OSM_CTL, OSM_ALT, OSM_SFT, OSM_GUI, XXXXXXX,     KC_F16,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX, \
